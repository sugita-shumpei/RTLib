...
void RTLib::Utils::to_json(nlohmann::json& json, const CameraController& cameraController)
{
...
void RTLib::Utils::to_json(nlohmann::json& json, const Camera& camera)
{
...
void RTLib::Utils::from_json(const nlohmann::json& json, CameraController& cameraController)
{
...
void RTLib::Utils::from_json(const nlohmann::json& json, Camera& camera)
{
