...
namespace RTLib {
	namespace Ext
	{
		namespace OPX7
		{
			using OPX7ShaderTableLayout           = RTLib::Core::ShaderTableLayout;
			using OPX7ShaderTableLayoutGeometryAS = RTLib::Core::ShaderTableLayoutGeometryAS;
			using OPX7ShaderTableLayoutGeometry   = RTLib::Core::ShaderTableLayoutGeometry;
			using OPX7ShaderTableLayoutInstanceAS = RTLib::Core::ShaderTableLayoutInstanceAS;
			using OPX7ShaderTableLayoutInstance   = RTLib::Core::ShaderTableLayoutInstance;
			using OPX7ShaderTableLayoutDesc       = RTLib::Core::ShaderTableLayoutDesc;
			using OPX7ShaderTableLayoutBaseDesc   = RTLib::Core::ShaderTableLayoutBaseDesc;
