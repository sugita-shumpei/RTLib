...
foreach(obj ${OBJECTS})
  ...
  elseif(obj_ext MATCHES ".ptx" OR obj_ext MATCHES ".optixir")
    ...
    file(READ ${obj} output HEX)
    string(REGEX REPLACE "([0-9a-f][0-9a-f])" "0x\\1," output ${output})
    string(CONCAT output 
        "#ifdef  __cplusplus\n"
        "extern \"C\"{\n"
        "#endif\n"
        "${const_decl}unsigned char ${obj_name}[] = {${output}};\n"
        "#ifdef  __cplusplus\n"
        "}\n"
        "#endif\n"
    )
...
if(HEADER)
  ...
  set(include_guard "OPTIX_${include_guard}")
