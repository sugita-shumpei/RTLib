...
namespace RTLib
{
	namespace Ext
	{
		namespace GL
		{
			...
			using GLImageSubresourceRange  = Core::ImageSubresourceRange;
			...
			using GLMemoryImageCopy = Core::MemoryImageCopy;
			...
			enum GLImageCreateFlagBits
			{
				GLImageCreateFlagsNone = 0,
				GLImageCreateFlagsCubemap = 1,
			};
			using  GLImageCreateFlags = unsigned int;
			struct GLImageCreateDesc
			{
				GLImageCreateFlags flags = GLImageCreateFlagsNone;
			...
			struct GLComponentMapping {
				GLComponentSwizzle r = GLComponentSwizzle::eR;
				GLComponentSwizzle g = GLComponentSwizzle::eG;
				GLComponentSwizzle b = GLComponentSwizzle::eB;
				GLComponentSwizzle a = GLComponentSwizzle::eA;
			};
			struct GLImageViewCreateDesc {
				GLImage*                image            = nullptr;
				GLImageViewType         viewType         = GLImageViewType::e1D ;
				GLFormat                format           = GLFormat::eRGBA8;
				GLComponentMapping      components       = {};
				GLImageSubresourceRange subresourceRange = {};
			};
			using  GLSamplerCreateDesc = Core::SamplerCreateDesc;
			struct GLTextureCreateDesc
			{
				GLImageCreateDesc image = {};
				GLSamplerCreateDesc sampler = {};
			};
