	...
	namespace Ext
	{
		namespace OPX7
		{
			...
			inline constexpr char* ToString(OPX7ContextValidationLogLevel level) {
				switch (level)
				{
				case RTLib::Ext::OPX7::OPX7ContextValidationLogLevel::eDisable: return "Disable";
					break;
				case RTLib::Ext::OPX7::OPX7ContextValidationLogLevel::eFatal:   return "Fatal";
					break;
				case RTLib::Ext::OPX7::OPX7ContextValidationLogLevel::eError:   return "Error";
					break;
				case RTLib::Ext::OPX7::OPX7ContextValidationLogLevel::eWarn:    return "Warn";
					break;
				case RTLib::Ext::OPX7::OPX7ContextValidationLogLevel::ePrint:   return "Print";
					break;
