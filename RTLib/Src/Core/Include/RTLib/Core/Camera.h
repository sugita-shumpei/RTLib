...
#include <vector>
#include <tuple>
#define RTLIB_CORE_CAMERA_MACRO_GETTER(TYPE,NAME, VARIABLE) \
...
#define RTLIB_CORE_CAMERA_MACRO_SETTER(TYPE, NAME, VARIABLE) \
...
#define RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER(TYPE, NAME,VARIABLE) \
    RTLIB_CORE_CAMERA_MACRO_GETTER(TYPE, NAME,VARIABLE); \
    RTLIB_CORE_CAMERA_MACRO_SETTER(TYPE, NAME,VARIABLE)
...
namespace RTLib
{
    namespace Core
    {
        ...
        public:
            ...
            RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER(Camera, Vup, m_Vup);
        ...
        public:
            ...
            RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER(CameraController, Position, m_Position);
            RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER(CameraController, Up, m_Up);
            RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER(CameraController, Yaw, m_Yaw);
            RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER(CameraController, Pitch, m_Pitch);
            RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER(CameraController, MouseSensitivity, m_MouseSensitivity);
            RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER(CameraController, MovementSpeed, m_MovementSpeed);
...
#undef RTLIB_CORE_CAMERA_MACRO_GETTER_AND_SETTER
#undef RTLIB_CORE_CAMERA_MACRO_GETTER
#undef RTLIB_CORE_CAMERA_MACRO_SETTER
#endif
