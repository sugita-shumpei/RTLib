#ifndef RTLIB_BACKENDS_CUDA_MATH_MATRIX_H
#define RTLIB_BACKENDS_CUDA_MATH_MATRIX_H
#include <RTLib/Backends/CUDA/Math/Preprocessors.h>
#include <RTLib/Backends/CUDA/Math/VectorFunction.h>
        ...
        namespace Cuda
        {
            namespace Math
            {
                ...
                public:
                    ...
                    RTLIB_INLINE RTLIB_HOST_DEVICE auto Det() const noexcept -> float
                    {
                        return RTLIB_IMPL_MATRIX_MUL_4(0, 0, 1, 1, 2, 2, 3, 3) + RTLIB_IMPL_MATRIX_MUL_4(0, 0, 1, 2, 2, 3, 3, 1) + RTLIB_IMPL_MATRIX_MUL_4(0, 0, 1, 3, 2, 1, 3, 2) +
